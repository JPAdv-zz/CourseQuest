    ...
    function renderResults(data){
        if(currentView == 'listView'){
            ...
            for(var i = 0; i < data.length; i++){
                ...
                elem.innerHTML ="<div class='play-button-container'><div onclick='loadPreviewVideo(\""+data[i].video_link+"\")' class='play-button'></div><div class='grid_view_more_info' title='Description: "+data[i].short_desc+" / Start Date is "+data[i].start_date+". / Duration is "+data[i].course_length+" weeks.'>i</div></div>"+
