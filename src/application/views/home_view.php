    ...
    function renderJsonResults(data,id,viewType){
        ...
        if(view == 'listView'){
            ...
            for(var i = 0; i < data.length; i++){
                ...
                elem.innerHTML ="<div class='play-button-container'><div onclick='loadPreviewVideo(\""+data[i].video_link+"\")' class='an-tr-op play-button'></div><div class='grid_view_more_info an-tr-op' title='Description: "+data[i].short_desc+" / Start Date is "+data[i].start_date+". / Duration is "+data[i].course_length+" weeks.'>i</div></div>"+
